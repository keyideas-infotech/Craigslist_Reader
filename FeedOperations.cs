...
namespace CraigslistReader
{
    ...
    {
        public static List<CLFeeds> GetValidNonPubSubFeeds(int Action)
        {
            List<CLFeeds> feeds = null;
            ...
            {                
                ...
                {
                    feeds = new List<CLFeeds>();
                    int i = 0;
                    foreach (DataRow row in table.Rows)
                    {
                        CLFeeds feed = new CLFeeds();
                        feed.RowNum = ++i;
        ...
        public static List<CLFeeds> GetValidGroupFeeds(string Pattern)
        {
            List<CLFeeds> feeds = null;
        ...
        public static bool SaveUpdateMail(CLFeedItem item, bool IsPubDate, decimal PollTime, int Action)
        {
