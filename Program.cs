    ...
    {        
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                List<CLFeeds> finalFeeds = FeedOperations.GetValidGroupFeeds("craigslist.org");
                int Counter = 0;
                ...
                {                    
                    if (Counter > 0)
                    {
                        ...
                        {
                            List<CLFeeds> objFeeds = finalFeeds.FindAll(u => u.RowNum > i && u.RowNum <= i + Counter);
        ...
        private static void StartProcess(List<CLFeeds> objFeeds)
        {           
            foreach (CLFeeds objFeed in objFeeds)
            {
